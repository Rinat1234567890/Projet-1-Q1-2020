...
"""
***Variables de base: la barge est supposée stable, carrée et n'oscille pas.***
"""
...
### Centre de gravite. Il faut les calculer à la main.
...
### Fonction de rotation. Elle met �  jour les valeurs nécessaires pour le calcul.
...
def simulation():
    ...
    for i in range(len(t)-1):
        ...
        alpha[i+1]=alpha[i]
        if abs(dist[i]-dist_t)>=abs(2*dist_v*dt):
